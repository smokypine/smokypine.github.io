...
- [상담 문의 이미지](./메인/상담.jpg)에 좌표를 지정하여 상세보기 위치를 클릭하면 ARS 상담 페이지가 출력되는 기능 구현.<br/><br/><br/>
...
- table 기능을 이용해 여행지 예약 페이지 구현.<br/><br/><br/>

## 2. 추가적 구현 목표
1) 로그인/회원가입/마이페이지 기능.
2) Database와의 연동을 통한 여행지 관리/예약 및 회원 관리 기능.
